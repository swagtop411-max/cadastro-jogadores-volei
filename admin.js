...
function installAdminPrivateStyles(){
  if(!document.getElementById("adminPrivateV32Css")){
    ...
    link.rel="stylesheet";
    link.href="./admin-private-v32.css?v=20260908-39";
  ...
  if(!document.getElementById("adminCommandV33Css")){
    ...
    link.rel="stylesheet";
    link.href="./admin-command-center-v33.css?v=20260908-39";
    document.head.appendChild(link);
  }
  if(!document.getElementById("adminMobileV39Css")){
    const link=document.createElement("link");
    link.id="adminMobileV39Css";
    link.rel="stylesheet";
    link.href="./admin-mobile-v39.css?v=20260908-39";
    document.head.appendChild(link);
  }
...
async function bootPrivateConsole(){
  ...
  try{
    await import("./owner-core-5e8a7c2d.js?v=20260908-39");
    await Promise.allSettled([
      import("./admin-v8-hardening.js?v=20260908-39"),
      import("./admin-claims-v9.js?v=20260908-39"),
      import("./admin-profile-link-v10.js?v=20260908-39"),
      import("./admin-control-center-v32.js?v=20260908-39"),
      import("./admin-command-center-v33.js?v=20260908-39"),
      import("./admin-data-migration-v11.js?v=20260908-39"),
      import("./admin-commerce-v11.js?v=20260908-39"),
      import("./admin-profile-browser-v13.js?v=20260908-39")
    ]);
  }catch(error){
