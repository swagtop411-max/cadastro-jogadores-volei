...
const fallback="data:image/svg+xml;charset=UTF-8,"+encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="160" height="160"><rect width="160" height="160" fill="#eef2f7"/><text x="80" y="100" text-anchor="middle" font-size="58">🏐</text></svg>');
...
function installFeedStyles(){
 ...
 .home-social{max-width:900px!important;margin:0 auto 26px!important}.home-social-grid{display:block!important}.home-feed-column{width:100%!important}.social-stories-wrap{border:1px solid #e4e7ec;border-radius:16px;padding:12px 12px 8px;background:#f8fafc;margin-bottom:16px}.social-stories{display:flex!important;gap:14px!important;overflow-x:auto!important;scrollbar-width:none!important}.social-stories::-webkit-scrollbar{display:none}.story-item{flex:0 0 72px;text-align:center;color:#344054;font:800 9px Arial;cursor:pointer}.story-item span{display:block;margin-top:6px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.home-feed{display:grid;gap:18px}.social-post{overflow:hidden;border:1px solid #e4e7ec;border-radius:17px;background:#fff;box-shadow:0 8px 28px rgba(15,23,42,.06)}.social-post-head{display:flex;align-items:center;gap:10px;padding:12px 14px}.feed-avatar{width:38px;height:38px;border-radius:50%;object-fit:cover;border:2px solid #dbeafe}.social-author{color:#172033!important;text-decoration:none!important;font:900 12px Arial}.feed-author-copy{flex:1;min-width:0}.feed-author-copy small{display:block;color:#98a2b3;font-size:9px;margin-top:3px}.social-date{color:#98a2b3;font-size:9px}.social-media-frame{position:relative;width:100%;background:#f2f4f7;display:flex;align-items:center;justify-content:center;max-height:760px;overflow:hidden}.social-media-frame img,.social-media-frame video{display:block;width:100%;height:auto;max-height:760px;object-fit:contain;background:#f2f4f7}.social-feed-video{min-height:260px}.feed-kind{position:absolute;right:10px;top:10px;padding:5px 8px;border-radius:30px;background:rgba(15,23,42,.68);color:#fff;font-size:10px}.social-post-body{padding:10px 14px 13px;background:#fff}.social-actions{display:flex;align-items:center;gap:8px}.social-actions button{border:0;background:transparent;color:#475467;font-size:20px;cursor:pointer;padding:5px}.social-actions button b{font-size:11px}.social-actions .home-save{margin-left:auto}.social-actions .active{color:#2563eb}.social-likes{margin:4px 0 6px;font-size:11px}.social-text{font-size:12px;line-height:1.45;margin:3px 0 7px;color:#344054;white-space:pre-wrap}.view-comments{border:0;background:transparent;color:#667085;padding:0;cursor:pointer;font-size:10px}.social-comments-modal{position:fixed;inset:0;z-index:23000;background:rgba(15,23,42,.35);display:none;place-items:center;padding:15px;backdrop-filter:blur(8px)}.social-comments-modal.open{display:grid}.social-comments-box{width:min(520px,100%);max-height:80vh;display:flex;flex-direction:column;background:#fff;border:1px solid #e4e7ec;border-radius:16px;overflow:hidden;box-shadow:0 28px 90px rgba(15,23,42,.18)}.comments-head{display:flex;align-items:center;justify-content:space-between;padding:13px 15px;border-bottom:1px solid #e4e7ec}.comments-head h3{margin:0;color:#172033}.social-comments-close{border:0;background:transparent;color:#475467;font-size:24px}.social-comments-list{overflow:auto;flex:1;padding:10px}.social-comment{display:flex;gap:8px;padding:9px}.social-comment img{width:31px;height:31px;border-radius:50%;object-fit:cover}.social-comment div{min-width:0}.social-comment strong{display:block;font-size:10px;color:#172033}.social-comment span{font-size:11px;color:#475467}.social-comment-form{display:flex;gap:7px;padding:10px;border-top:1px solid #e4e7ec}.social-comment-form input{flex:1;min-width:0;border:1px solid #d0d5dd;border-radius:20px;background:#f8fafc;color:#172033;padding:10px 13px}.social-comment-form button{border:0;border-radius:20px;background:#2563eb;color:#fff;padding:0 15px;font-weight:900}.social-login-gate{padding:28px;text-align:center;border:1px solid #e4e7ec;border-radius:15px;background:#f8fafc;color:#667085}.social-login-gate strong,.social-login-gate span{display:block}.social-login-gate span{margin-top:5px;color:#98a2b3;font-size:11px}.social-login-gate a{display:inline-block;margin-top:11px;color:#2563eb}.feed-heart-pop{position:absolute;inset:0;display:grid;place-items:center;pointer-events:none;font-size:80px;opacity:0;transform:scale(.5);transition:.25s}.feed-heart-pop.show{opacity:.9;transform:scale(1)}
 @media(max-width:700px){.home-social{max-width:none!important;margin-left:0!important;margin-right:0!important}.social-post{border-radius:14px}.social-media-frame img,.social-media-frame video{max-height:70vh}}
