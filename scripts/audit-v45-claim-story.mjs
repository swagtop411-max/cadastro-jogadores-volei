...
need("profile-story-access-v45.js",'where("visibilidade", "==", "publico")',"visitante consulta apenas Stories públicos");
need("profile-story-access-v45.js",'where("aprovado", "==", true)',"Stories exigem aprovação");
need("profile-story-access-v45.js",'created + 24 * 60 * 60 * 1000',"Story legado recebe janela de 24h");
need("profile-story-access-v45.js",'openStoryViewer(activeStories, 0)',"foto do perfil abre Story ativo");
need("profile-story-access-v45.js",'profile-highlight-v45',"Stories expirados aparecem em Destaques");
...
need("avatar-story-v36.js",'profile-story-access-v45.js?v=20260909-45',"avatar carrega controle seguro V45");
...
need("sw.js",'/profile-story-access-v45.js',"novo módulo de Stories está no cache");
